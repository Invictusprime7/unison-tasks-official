...
- **Six art direction families.** Modern, Bold, Editorial, Minimalist, Futuristic and Organic are complete visual philosophies, each holding several certified directions — not colour skins. A direction is only offered if it can build every part of a site, and a site's family is saved with it and honoured by preview, editing and publishing.
