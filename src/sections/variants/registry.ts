...
const VARIANT_REGISTRY: VariantRegistry = {
  ...
  pricing: [
    ...
    },
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:8374',
        sourceUrl: 'https://21st.dev/@dgearsonu1/components/pricing-table',
        author: 'dgearsonu1',
  ...
  gallery: [
    ...
    },
    {
      ...
      vfs: { mode: 'portable-recipe', certification: 'approved' },
      source: { origin: '21st', sourceId: '21st:4746', sourceUrl: 'https://21st.dev/efferd/image-gallery', author: 'efferd', derivation: 'visual-reference', adaptationVersion: '1' },
    ...
    },
    {
      ...
      vfs: { mode: 'portable-recipe', certification: 'approved' },
      source: { origin: '21st', sourceId: '21st:1358', sourceUrl: 'https://21st.dev/shadcnblockscom/gallery4', author: 'shadcnblockscom', derivation: 'visual-reference', adaptationVersion: '1' },
      generationStatus: 'supported',
      radixPrimitives: ['dialog'],
    ...
    },
    {
      ...
      vfs: { mode: 'portable-recipe', certification: 'approved' },
      source: { origin: '21st', sourceId: '21st:4869', sourceUrl: 'https://21st.dev/prebuiltui/image-gallery', author: 'prebuiltui', derivation: 'visual-reference', adaptationVersion: '1' },
      generationStatus: 'supported',
      radixPrimitives: ['dialog'],
  ...
  hero: [
    ...
    { id: 'hero:launch-showcase', sectionType: 'hero', slug: 'launch-showcase', name: 'Centered headline and actions above a framed media showcase', description: 'Centered headline and actions above a framed media showcase', component: HeroLaunchShowcase, vfs: { mode: 'portable-recipe', certification: 'approved' }, source: {"origin":"21st","sourceId":"21st:1526","sourceUrl":"https://21st.dev/@mikolajdobrucki/components/hero-section","author":"mikolajdobrucki","derivation":"source-adaptation","license":"MIT","adaptationVersion":"2"}, generationStatus: 'preferred', thumbnail: '/variants/hero-launch-showcase.svg', renderJSX: portableRecipeOnly },
    {
      ...
      source: {
        ...
        author: 'rahil1202',
        license: 'Owner-authorized adaptation (21st.dev publication by @rahil1202 declares no upstream license)',
        adaptationVersion: '2',
      },
      generationStatus: 'preferred',
    ...
    },
    {
      ...
      slug: 'centered',
      name: 'Centered',
      description: 'Ruled centered frame with announcement badge, display headline and paired actions',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:10024',
        sourceUrl: 'https://21st.dev/efferd/hero-1',
        author: 'efferd',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
    ...
    },
    {
      ...
      slug: 'split-image',
      name: 'Split Image',
      description: 'Two-column layout with outline badge, tracking-tight headline and a square media panel',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:1160',
        sourceUrl: 'https://21st.dev/tommyjepsen/hero-with-image-text-and-two-buttons',
        author: 'tommyjepsen',
        license: 'MIT',
        adaptationVersion: '2',
      },
    ...
    },
    {
      ...
      slug: 'full-bleed',
      name: 'Full Bleed',
      description: 'Full-screen stage with drifting aurora light behind centered text overlay',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:6834',
        sourceUrl: 'https://21st.dev/ravikatiyar162/hero-2',
    ...
    },
    {
      ...
      name: 'Page Title', description: 'Breadcrumb trail above the page title inside a raised card',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:18129',
        sourceUrl: 'https://21st.dev/uiable/uiable-breadcrumb-page-header',
        author: 'uiable',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
  ...
  cta: [
    { id: 'cta:inset-panel', sectionType: 'cta', slug: 'inset-panel', name: 'Centered conversion message and actions inside a muted inset panel', description: 'Centered conversion message and actions inside a muted inset panel', component: CTAInsetPanel, vfs: { mode: 'portable-recipe', certification: 'approved' }, source: {"origin":"21st","sourceId":"21st:1414","sourceUrl":"https://21st.dev/@tommyjepsen/components/call-to-action","author":"tommyjepsen","derivation":"source-adaptation","license":"MIT","adaptationVersion":"2"}, generationStatus: 'preferred', thumbnail: '/variants/cta-inset-panel.svg', renderJSX: portableRecipeOnly },
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:19341',
        sourceUrl: 'https://21st.dev/@thegridcn/components/cta-banner',
        author: 'thegridcn',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
  ...
  navbar: [
    { id: 'navbar:catalog-bar', sectionType: 'navbar', slug: 'catalog-bar', name: 'Brand, desktop navigation and action with an accessible mobile drawer', description: 'Brand, desktop navigation and action with an accessible mobile drawer', component: NavbarCatalogBar, radixPrimitives: ['dialog'], vfs: { mode: 'portable-recipe', certification: 'approved' }, source: {"origin":"21st","sourceId":"21st:606","sourceUrl":"https://21st.dev/@shadcnblockscom/components/shadcnblocks-com-navbar1","author":"shadcnblockscom","derivation":"visual-reference","adaptationVersion":"2"}, generationStatus: 'preferred', thumbnail: '/variants/navbar-catalog-bar.svg', renderJSX: portableRecipeOnly },
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:8137',
        sourceUrl: 'https://21st.dev/@efferd/components/floating-header',
        author: 'efferd',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
    ...
    },
    {
      ...
      slug: 'standard',
      name: 'Standard',
      description: 'Ruled plus-grid header with full-height link cells and an accessible mobile drawer',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:18258',
        sourceUrl: 'https://21st.dev/karthikmudunuri/header-02',
    ...
    },
    {
      ...
      slug: 'centered-logo',
      name: 'Centered Logo',
      description: 'Floating header with a centred menu island that condenses on scroll',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:4003',
        sourceUrl: 'https://21st.dev/designali-in/navbar',
        author: 'designali-in',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
      ...
      tags: ['editorial', 'elegant', 'floating'],
    ...
    },
    {
      ...
      slug: 'minimal-dark',
      name: 'Minimal Dark',
      description: 'Inverted three-column bar with a divided action group and pill CTA',
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:841',
        sourceUrl: 'https://21st.dev/tommyjepsen/header',
        author: 'tommyjepsen',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
  ...
  services: [
    ...
    },
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:8286',
        sourceUrl: 'https://21st.dev/@ravikatiyar162/components/product-card-2',
        author: 'ravikatiyar162',
        license: 'Owner-authorized source adaptation (approved for canonical Unison generation)',
        adaptationVersion: '2',
      },
  ...
  footer: [
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:646',
        sourceUrl: 'https://21st.dev/@nevsky118/components/footer',
        author: 'nevsky118',
        license: 'MIT',
        adaptationVersion: '2',
      },
  ...
  about: [
    {
      ...
      tags: ['premium', 'route-design', 'page-design:editorial', 'page-design:showcase'],
      pageRoles: ['home', 'about', 'services', 'pricing', 'gallery', 'booking', 'contact', 'faq', 'checkout', 'thank_you'],
  ...
  faq: [
    {
      ...
      tags: ['premium', 'route-design', 'page-design:showcase'],
      pageRoles: ['home', 'faq', 'services', 'contact', 'checkout', 'pricing', 'booking', 'thank_you', 'about'],
  ...
  stats: [
    ...
    },
    {
      ...
      source: {
        ...
        derivation: 'source-adaptation',
        sourceId: '21st:1195',
        sourceUrl: 'https://21st.dev/@tommyjepsen/components/stats-section-with-text',
        author: 'tommyjepsen',
        license: 'MIT',
        adaptationVersion: '2',
      },
  ...
  'before-after': [
    { id: 'before-after:reveal-panel', sectionType: 'before-after', slug: 'reveal-panel', name: 'Keyboard-operable image comparison with selectable results', description: 'Keyboard-operable image comparison with selectable results', component: BeforeAfterRevealPanel, vfs: { mode: 'portable-recipe', certification: 'approved' }, source: {"origin":"21st","sourceId":"21st:24683","sourceUrl":"https://21st.dev/@motiondotdev/components/motion-image-reveal-slider","author":"motiondotdev","derivation":"visual-reference","adaptationVersion":"2"}, generationStatus: 'preferred', thumbnail: '/variants/before-after-reveal-panel.svg', renderJSX: portableRecipeOnly },
    {
      ...
      vfs: { mode: 'portable-recipe', certification: 'approved' },
      source: { origin: '21st', sourceId: '21st:703', sourceUrl: 'https://21st.dev/tommyjepsen/feature-with-image-comparison', author: 'tommyjepsen', derivation: 'visual-reference', adaptationVersion: '1' },
      generationStatus: 'supported',
    ...
    },
    {
      ...
      vfs: { mode: 'portable-recipe', certification: 'approved' },
      source: { origin: '21st', sourceId: '21st:285', sourceUrl: 'https://21st.dev/manuarora700/compare', author: 'manuarora700', derivation: 'visual-reference', adaptationVersion: '1' },
      generationStatus: 'supported',
