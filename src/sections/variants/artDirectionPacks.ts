...
export const ART_DIRECTION_PACKS: Record<ArtDirectionPackId, ArtDirectionPack> = {
  ...
  'bold-commercial': {
    ...
    sectionFamilies: {
      ...
      gallery: ['gallery:collection-tiles', 'gallery:lightbox-grid', 'gallery:masonry'],
      services: ['services:product-cards', 'services:card-grid', 'services:compact-list'],
      features: ['features:bento-grid', 'features:icon-left', 'features:grid'],
      'logo-cloud': ['logo-cloud:wordmark-row', 'logo-cloud:grid', 'logo-cloud:marquee'],
      testimonials: ['testimonials:marquee', 'testimonials:rail', 'testimonials:grid'],
      pricing: ['pricing:feature-table', 'pricing:comparison', 'pricing:tiers'],
      cta: ['cta:signal-banner', 'cta:gradient-banner', 'cta:split-card'],
      contact: ['contact:split-card', 'contact:centered'],
      about: ['about:editorial-split', 'about:statement'],
      faq: ['faq:accordion', 'faq:cards'],
      stats: ['stats:metric-cards', 'stats:row', 'stats:banded-grid'],
      team: ['team:portrait-grid', 'team:roster-rail'],
    },
  ...
  'commerce-editorial': {
    ...
    sectionFamilies: {
      ...
      gallery: ['gallery:collection-tiles', 'gallery:masonry', 'gallery:lightbox-grid'],
      services: ['services:product-cards', 'services:card-grid', 'services:compact-list'],
      features: ['features:bento-grid', 'features:grid', 'features:minimal-centered'],
      'logo-cloud': ['logo-cloud:wordmark-row', 'logo-cloud:grid', 'logo-cloud:marquee'],
      testimonials: ['testimonials:marquee', 'testimonials:grid', 'testimonials:rail'],
      pricing: ['pricing:feature-table', 'pricing:tiers', 'pricing:comparison'],
      cta: ['cta:signal-banner', 'cta:gradient-banner', 'cta:split-card'],
      contact: ['contact:split-card', 'contact:centered'],
      about: ['about:editorial-split', 'about:statement'],
      faq: ['faq:accordion', 'faq:cards'],
