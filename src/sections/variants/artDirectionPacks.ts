...
export const ART_DIRECTION_PACKS: Record<ArtDirectionPackId, ArtDirectionPack> = {
  'editorial-noir': {
    ...
    sectionFamilies: {
      ...
      pricing: ['pricing:tiers', 'pricing:comparison', 'pricing:spotlight'],
      cta: ['cta:split-card', 'cta:centered'],
      contact: ['contact:split-card', 'contact:centered', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
  ...
  'cinematic-portfolio': {
    ...
    sectionFamilies: {
      ...
      testimonials: ['testimonials:spotlight', 'testimonials:rail', 'testimonials:columns'],
      pricing: ['pricing:tiers', 'pricing:accordion', 'pricing:spotlight'],
      cta: ['cta:centered', 'cta:split-card'],
      contact: ['contact:split-card', 'contact:minimal-inline', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
  ...
  'luxury-minimal': {
    ...
    sectionFamilies: {
      ...
      pricing: ['pricing:tiers', 'pricing:comparison', 'pricing:spotlight'],
      cta: ['cta:centered', 'cta:split-card'],
      contact: ['contact:minimal-inline', 'contact:centered', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
  ...
  'soft-editorial': {
    ...
    sectionFamilies: {
      ...
      testimonials: ['testimonials:grid', 'testimonials:rail', 'testimonials:columns'],
      pricing: ['pricing:tiers', 'pricing:accordion', 'pricing:spotlight'],
      cta: ['cta:split-card', 'cta:centered'],
      contact: ['contact:centered', 'contact:split-card', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:story-panel', 'about:editorial-split', 'about:image-story'],
      faq: ['faq:two-column', 'faq:accordion', 'faq:editorial', 'faq:searchable'],
      stats: ['stats:highlight', 'stats:row', 'stats:proof-grid'],
      team: ['team:lead-spotlight', 'team:portrait-grid'],
  ...
  'bold-commercial': {
    ...
    sectionFamilies: {
      hero: ['hero:showcase-panel', 'hero:commerce-gradient', 'hero:split-image', 'hero:full-bleed'],
      ...
      pricing: ['pricing:feature-table', 'pricing:comparison', 'pricing:tiers', 'pricing:spotlight'],
  ...
  'glass-tech': {
    ...
    sectionFamilies: {
      ...
      services: ['services:card-grid', 'services:alternating', 'services:bento-spotlight', 'services:editorial-rows', 'services:expandable'],
      features: ['features:grid', 'features:icon-left', 'features:spotlight-cards'],
      testimonials: ['testimonials:grid', 'testimonials:spotlight', 'testimonials:columns'],
      pricing: ['pricing:comparison', 'pricing:tiers', 'pricing:spotlight'],
  ...
  'organic-studio': {
    ...
    sectionFamilies: {
      ...
      services: ['services:alternating', 'services:card-grid', 'services:bento-spotlight', 'services:editorial-rows', 'services:expandable'],
      features: ['features:minimal-centered', 'features:grid', 'features:spotlight-cards'],
      testimonials: ['testimonials:rail', 'testimonials:spotlight', 'testimonials:columns'],
      pricing: ['pricing:accordion', 'pricing:tiers', 'pricing:spotlight'],
      cta: ['cta:centered', 'cta:split-card'],
      contact: ['contact:centered', 'contact:split-card', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:story-panel', 'about:editorial-split', 'about:image-story'],
      faq: ['faq:two-column', 'faq:accordion', 'faq:editorial', 'faq:searchable'],
  ...
  'commerce-editorial': {
    ...
    sectionFamilies: {
      hero: ['hero:commerce-gradient', 'hero:showcase-panel', 'hero:full-bleed', 'hero:split-image'],
      ...
      pricing: ['pricing:feature-table', 'pricing:tiers', 'pricing:comparison', 'pricing:spotlight'],
      cta: ['cta:signal-banner', 'cta:gradient-banner', 'cta:split-card'],
      contact: ['contact:split-card', 'contact:centered', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:editorial-split', 'about:statement', 'about:image-story'],
      faq: ['faq:accordion', 'faq:cards', 'faq:editorial', 'faq:searchable'],
  ...
  'swiss-grid': {
    ...
    sectionFamilies: {
      ...
      pricing: ['pricing:comparison', 'pricing:tiers', 'pricing:spotlight'],
      cta: ['cta:split-card', 'cta:centered'],
      contact: ['contact:minimal-inline', 'contact:split-card', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:statement', 'about:editorial-split', 'about:image-story'],
      faq: ['faq:cards', 'faq:accordion', 'faq:editorial', 'faq:searchable'],
      stats: ['stats:banded-grid', 'stats:row', 'stats:proof-grid'],
      team: ['team:roster-rail', 'team:portrait-grid'],
  ...
  'print-serif': {
    ...
    sectionFamilies: {
      ...
      pricing: ['pricing:tiers', 'pricing:accordion', 'pricing:spotlight'],
      cta: ['cta:centered', 'cta:split-card'],
      contact: ['contact:centered', 'contact:minimal-inline', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:story-panel', 'about:editorial-split', 'about:image-story'],
      faq: ['faq:two-column', 'faq:accordion', 'faq:editorial', 'faq:searchable'],
      stats: ['stats:highlight', 'stats:row', 'stats:proof-grid'],
      team: ['team:lead-spotlight', 'team:portrait-grid'],
  ...
  'neon-grid': {
    ...
    sectionFamilies: {
      ...
      services: ['services:card-grid', 'services:alternating', 'services:bento-spotlight', 'services:editorial-rows', 'services:expandable'],
      features: ['features:grid', 'features:icon-left', 'features:spotlight-cards'],
      testimonials: ['testimonials:rail', 'testimonials:grid', 'testimonials:columns'],
      pricing: ['pricing:comparison', 'pricing:tiers', 'pricing:spotlight'],
      cta: ['cta:gradient-banner', 'cta:centered'],
      contact: ['contact:split-card', 'contact:centered', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:editorial-split', 'about:statement', 'about:image-story'],
  ...
  'mono-terminal': {
    ...
    sectionFamilies: {
      ...
      testimonials: ['testimonials:grid', 'testimonials:rail', 'testimonials:columns'],
      pricing: ['pricing:comparison', 'pricing:accordion', 'pricing:spotlight'],
      cta: ['cta:split-card', 'cta:centered'],
      contact: ['contact:minimal-inline', 'contact:split-card', 'contact:editorial-form', 'contact:map-studio', 'contact:checkout-panel'],
      about: ['about:statement', 'about:editorial-split', 'about:image-story'],
      faq: ['faq:cards', 'faq:accordion', 'faq:editorial', 'faq:searchable'],
