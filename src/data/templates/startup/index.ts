            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div data-demo-form-host>
                <form class="mt-4 grid sm:grid-cols-3 gap-3" data-demo-form>
                  ...
                  <button class="px-4 py-3 rounded-xl bg-gradient-to-r ${gradient} text-white font-bold">Notify me</button>
                </form>
              </div>
            </div>
          </div>
  ...
  <div class="relative max-w-6xl mx-auto rounded-2xl border border-white/10 bg-gradient-to-r ${gradient} px-5 py-4 shadow-2xl shadow-black/30">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        <button class="px-4 py-2 rounded-xl bg-white/15 hover:bg-white/20 border border-white/20 text-sm font-semibold tw-focus" data-toggle="#demo-startup-${safeId}">Details</button>
...
<section class="py-16 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl mx-6"><div class="max-w-3xl mx-auto text-center"><h2 class="text-3xl font-bold mb-4">Ready to automate your workflow?</h2><p class="text-white/80 mb-8">Start your free trial today. No credit card required.</p><button class="px-10 py-4 bg-white text-indigo-600 font-bold rounded-xl">Get Started Free</button></div></section>
