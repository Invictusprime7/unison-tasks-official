    ...
    <div class="grid lg:grid-cols-3 gap-8 items-stretch">
      ...
      <div class="rounded-3xl border ${frame} p-8" data-demo-form-host>
        ...
        <form class="mt-6 space-y-3" data-demo-form data-demo-message="You're in! Watch your inbox for member-only offers.">
          ...
          <button type="submit" class="w-full px-4 py-3 rounded-xl bg-gradient-to-r ${ctaGradient} text-white font-semibold tw-focus">${opts.offerCta}</button>
  ...
  <div class="relative max-w-5xl mx-auto rounded-2xl border border-white/10 bg-gradient-to-r ${ctaGradient} px-5 py-4 shadow-2xl shadow-black/30">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        <button class="px-4 py-2 rounded-xl bg-white/15 hover:bg-white/20 border border-white/20 text-sm font-semibold tw-focus" data-toggle="#demo-sticky-cta-${safeId}">
          Details
        </button>
        <button class="px-5 py-2 rounded-xl bg-white text-black text-sm font-bold tw-focus">${opts.offerCta}</button>
      </div>
    </div>
