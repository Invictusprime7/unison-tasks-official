            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div data-demo-form-host>
                <form class="mt-4 grid sm:grid-cols-3 gap-3" data-demo-form>
                  ...
                  <button class="px-4 py-3 rounded-xl bg-gradient-to-r ${gradient} text-white font-bold" data-intent="newsletter.subscribe">Subscribe</button>
                </form>
              </div>
            </div>
          </div>
  ...
  <div class="relative max-w-6xl mx-auto rounded-2xl border border-white/10 bg-gradient-to-r ${gradient} px-5 py-4 shadow-2xl shadow-black/30">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        <button class="px-4 py-2 rounded-xl bg-white/15 hover:bg-white/20 border border-white/20 text-sm font-semibold tw-focus" data-toggle="#demo-restaurant-${safeId}" data-intent="none">Hours</button>
        <button class="px-5 py-2 rounded-xl bg-white text-black text-sm font-bold tw-focus" data-intent="reservation.start">${opts.primaryCta}</button>
      </div>
    </div>
...
<section class="py-24 px-6" id="reserve"><div class="max-w-3xl mx-auto text-center"><span class="text-amber-500 text-sm tracking-widest">RESERVATIONS</span><h2 class="text-4xl font-light tracking-wider mt-4 mb-6">Reserve Your Experience</h2><p class="text-slate-400 mb-10">Dinner service: Tuesday - Saturday, 6pm - 10pm</p><form class="space-y-6" data-intent="reservation.submit"><div class="grid md:grid-cols-2 gap-6"><input type="text" name="name" placeholder="Name" class="px-5 py-4 bg-white/5 border border-white/10 rounded-lg focus:border-amber-500 outline-none"/><input type="email" name="email" placeholder="Email" class="px-5 py-4 bg-white/5 border border-white/10 rounded-lg focus:border-amber-500 outline-none"/><input type="date" name="date" class="px-5 py-4 bg-white/5 border border-white/10 rounded-lg focus:border-amber-500 outline-none"/><select name="guests" class="px-5 py-4 bg-white/5 border border-white/10 rounded-lg focus:border-amber-500 outline-none"><option>2 Guests</option><option>4 Guests</option><option>6 Guests</option></select></div><button class="w-full py-4 bg-amber-500 text-black font-medium tracking-wider rounded-lg" data-intent="reservation.submit">REQUEST RESERVATION</button></form></div></section>
