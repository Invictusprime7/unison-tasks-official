    ...
    <div class="grid lg:grid-cols-3 gap-10 items-start">
      ...
      <aside class="rounded-3xl border border-white/10 bg-slate-900/50 p-8" data-demo-form-host>
        ...
        <form class="mt-6 space-y-3" data-demo-form data-demo-message="Request received! We'll reach out shortly with next steps.">
          ...
          <button type="submit" class="w-full px-4 py-3 rounded-xl bg-gradient-to-r ${ctaGradient} text-black font-bold tw-focus">${opts.cta}</button>
  ...
  <div class="relative max-w-5xl mx-auto rounded-2xl border border-white/10 bg-gradient-to-r ${ctaGradient} px-5 py-4 shadow-2xl shadow-black/30">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        ...
        <button class="px-5 py-2 rounded-xl bg-black text-white text-sm font-bold tw-focus">${opts.cta}</button>
      </div>
    </div>
...
<section class="py-24 px-6 bg-amber-500 text-black"><div class="max-w-4xl mx-auto text-center"><h2 class="text-3xl font-bold mb-6">Ready to Start Your Project?</h2><p class="text-black/70 text-xl mb-8">Get a free consultation and estimate from our experts.</p><div class="flex flex-col md:flex-row gap-4 justify-center"><input type="text" placeholder="Your name" class="px-6 py-4 rounded-lg outline-none"/><input type="tel" placeholder="Phone number" class="px-6 py-4 rounded-lg outline-none"/><button class="px-8 py-4 bg-black text-white font-bold rounded-lg">Get Free Quote</button></div></div></section>
