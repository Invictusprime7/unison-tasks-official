...
export const INDUSTRY_MATRIX: Record<string, IndustryProfile> = {
  saas: {
    ...
    defaultPages: [
      ...
      { title: 'Features', path: '/services', purpose: 'services', expectedSections: ['navbar', 'hero', 'features', 'services', 'footer'] },
      { title: 'Pricing', path: '/pricing', purpose: 'pricing', expectedSections: ['navbar', 'hero', 'pricing', 'faq', 'footer'] },
  ...
  salon: {
    ...
    defaultPages: [
      ...
      { title: 'Services', path: '/services', purpose: 'services', expectedSections: ['navbar', 'hero', 'services', 'pricing', 'footer'] },
      { title: 'Book', path: '/booking', purpose: 'booking', expectedSections: ['navbar', 'hero', 'services', 'contact', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
  ...
  restaurant: {
    ...
    defaultPages: [
      ...
      { title: 'Menu', path: '/menu', purpose: 'services', expectedSections: ['navbar', 'hero', 'services', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
  ...
  'real-estate': {
    ...
    defaultPages: [
      ...
      { title: 'Listings', path: '/listings', purpose: 'portfolio', expectedSections: ['navbar', 'hero', 'gallery', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
  ...
  ecommerce: {
    ...
    defaultPages: [
      { title: 'Home', path: '/', purpose: 'landing', expectedSections: ['navbar', 'hero', 'services', 'testimonials', 'cta', 'footer'] },
      { title: 'Shop', path: '/shop', purpose: 'shop', expectedSections: ['navbar', 'hero', 'services', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
  ...
  portfolio: {
    ...
    defaultPages: [
      ...
      { title: 'Work', path: '/work', purpose: 'portfolio', expectedSections: ['navbar', 'hero', 'gallery', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
  ...
  nonprofit: {
    ...
    defaultPages: [
      ...
      { title: 'About', path: '/about', purpose: 'about', expectedSections: ['navbar', 'hero', 'about', 'team', 'footer'] },
      { title: 'Contact', path: '/contact', purpose: 'contact', expectedSections: ['navbar', 'hero', 'contact', 'footer'] },
    ],
